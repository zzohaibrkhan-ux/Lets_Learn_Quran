...
// Import Baqarah content
import baqarahContent from '@/data/baqarah-content.json'
...
export default function BaqarahApp() {
  ...
  const selectedChapterData = baqarahContent.chapters.find(
  ...
  const sortedChapters = [...baqarahContent.chapters].sort((a, b) => a.order - b.order)
                  ...
                  <Card className="border-2 border-green-200 dark:border-green-800 bg-white/90 dark:bg-slate-900/90 backdrop-blur">
                    <CardHeader className="text-center pb-4">
                      ...
                      <CardDescription className="text-base text-green-700 dark:text-green-300 max-w-2xl mx-auto">
                        {baqarahContent.meta.description}
                      </CardDescription>
                    </CardHeader>
                  </Card>
                  ...
                  <Card className="border-2 border-green-200 dark:border-green-800 bg-white/90 dark:bg-slate-900/90 backdrop-blur">
                    ...
                    <CardContent className="p-6">
                      ...
                      >
                        ...
                        {/* Images Section - Supports Multiple Images */}
                          ...
                          <div className="space-y-3 pt-4">
                            ...
                            <div className="space-y-4">
                              {selectedSectionData.images.map((imgSrc, index) => (
                                <div key={index} className="relative w-full overflow-hidden rounded-lg border-2 border-green-200 dark:border-green-800 shadow-md bg-slate-100 dark:bg-slate-800">
                                  <img
                                    src={imgSrc}
                                    alt={`${selectedSectionData.title || "Section Image"} - ${index + 1}`}
      ...
      <footer className="mt-auto border-t border-green-200 dark:border-green-800 bg-white/80 dark:bg-slate-900/80 backdrop-blur-sm">
        <div className="container mx-auto px-4 py-4 text-center">
          <p className="text-sm text-green-700 dark:text-green-300">
            {baqarahContent.meta.subtitle} - Learning Quranic Recitation Rules
          </p>
        </div>
      </footer>
    </div>
